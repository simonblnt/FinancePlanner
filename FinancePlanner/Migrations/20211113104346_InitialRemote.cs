        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDayLong = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinancialEventId = table.Column<int>(type: "int", nullable: false),
                    FitnessEventId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NumericalTarget = table.Column<int>(type: "int", nullable: false),
                    NumericalProgress = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SendingSchedule = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ScheduleWeekday = table.Column<int>(type: "int", nullable: false),
                    ScheduleDay = table.Column<int>(type: "int", nullable: false),
                    ScheduleMonth = table.Column<int>(type: "int", nullable: false),
                    ScheduleMonthlyDay = table.Column<int>(type: "int", nullable: false),
