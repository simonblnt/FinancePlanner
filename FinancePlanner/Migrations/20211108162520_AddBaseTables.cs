        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDayLong = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<int>(type: "integer", nullable: false),
                    FinancialEventId = table.Column<int>(type: "integer", nullable: false),
                    FitnessEventId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoalStatusId = table.Column<int>(type: "integer", nullable: false),
                    Title = table.Column<string>(type: "text", nullable: true),
                    NumericalTarget = table.Column<int>(type: "integer", nullable: false),
                    NumericalProgress = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "text", nullable: true),
                    SendingSchedule = table.Column<string>(type: "text", nullable: true),
                    ScheduleWeekday = table.Column<int>(type: "integer", nullable: false),
                    ScheduleDay = table.Column<int>(type: "integer", nullable: false),
                    ScheduleMonth = table.Column<int>(type: "integer", nullable: false),
                    ScheduleMonthlyDay = table.Column<int>(type: "integer", nullable: false),
